...
const Dashboard = () => {
  ...
  const [editingFood, setEditingFood] = useState({} as FoodInfo);
  ...
  return (
    <>
      ...
      <FoodsContainer data-testid="foods-list">{foods && foods.map((food) => <Food key={food.id} food={food} handleDelete={handleDeleteFood} handleEditFood={handleEditFood} />)}</FoodsContainer>
    </>
  );
};
